...
class FriendsPhotoController: UICollectionViewController {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "FriendsPhoto" {
            ...
            let myFriendsController = segue.destination as! MyFriendsController
            if let photo = UIImage(named: myFriendsController.avatarNames[(indexPath?.row)!]) {
               friendPhoto = photo
            }
    ...
    */
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.friendsPhoto.image = friendPhoto
